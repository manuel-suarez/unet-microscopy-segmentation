...
def UNetPP(input_shape=(256, 256, 1), batch_norm=True, dropout_rate=0.0):
    ...
    # X i=0, j=0
    x0_0 = convolutional_block(inputs, batch_norm, dropout_rate)
    p0_0 = layers.MaxPooling2D(pool_size=(2,2))(x0_0)
    # X i=1, j=0
    x1_0 = convolutional_block(p0_0, batch_norm, dropout_rate)
    p1_0 = layers.MaxPooling2D(pool_size=(2,2))(x1_0)
    # X i=2, j=0
    x2_0 = convolutional_block(p1_0, batch_norm, dropout_rate)
    p2_0 = layers.MaxPooling2D(pool_size=(2,2))(x2_0)
    # X i=3, j=0
    x3_0 = convolutional_block(p2_0, batch_norm, dropout_rate)
    p3_0 = layers.MaxPooling2D(pool_size=(2,2))(x3_0)
    # X i=4, j=0
    x4_0 = convolutional_block(p3_0, batch_norm, dropout_rate)
